    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full space-y-12">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-blue-hen sm:text-5xl md:text-6xl">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <Link 
              href="/join" 
              className="px-6 py-3 bg-blue-hen text-white font-medium rounded-md hover:bg-blue-800 transition-colors"
            >
              Join UDSSA
            </Link>
            <Link 
              href="/donate" 
              className="px-6 py-3 bg-gold text-blue-hen font-medium rounded-md hover:bg-yellow-400 transition-colors"
            >
              Support Us
            </Link>
          </div>
        ...
        <div className="bg-gray-50 p-8 rounded-lg">
          <h2 className="text-3xl font-bold text-blue-hen mb-4">Our Mission</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-blue-hen mb-2">Member Portfolios</h3>
            <p className="text-gray-600">Showcase your skills and projects to potential employers and collaborators.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-blue-hen mb-2">Events & Workshops</h3>
            <p className="text-gray-600">Participate in hands-on workshops, hackathons, and networking events.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-blue-hen mb-2">Services Marketplace</h3>
        ...
        {/* Call to Action */}
        <div className="text-center">
          <h2 className="text-2xl font-bold text-blue-hen mb-4">Ready to join the data revolution?</h2>
